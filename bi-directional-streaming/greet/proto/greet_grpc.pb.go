...
func (c *greetServiceClient) BiGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_BiGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet.GreetService/BiGreet", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceBiGreetClient) Send(m *GreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceBiGreetClient) Recv() (*GreetResponse, error) {
	m := new(GreetResponse)
...
func (x *greetServiceBiGreetServer) Send(m *GreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceBiGreetServer) Recv() (*GreetRequest, error) {
	m := new(GreetRequest)
