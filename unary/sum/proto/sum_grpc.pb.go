...
type SumServiceClient interface {
	Addition(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error)
}
...
func (c *sumServiceClient) Addition(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/sum.SumService/Addition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SumServiceServer interface {
	Addition(context.Context, *SumRequest) (*SumResponse, error)
...
func (UnimplementedSumServiceServer) Addition(context.Context, *SumRequest) (*SumResponse, error) {
...
func _SumService_Addition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SumServiceServer).Addition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sum.SumService/Addition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServiceServer).Addition(ctx, req.(*SumRequest))
	}
...
var SumService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Addition",
			Handler:    _SumService_Addition_Handler,
		},
	},
